...
個人 skills は非公開で同期し、公開 skills は公式ソースからインストール・更新します。
...
`manage-my-skills` は再利用可能な手順を検出し、新しい個人 skill の作成や既存 skill の更新を Agent から提案します。同時に、個人 skills とソース管理された公開 skills を端末・サーバー間で統一します。
